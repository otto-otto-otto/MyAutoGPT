  ...
  useEffect(() => {
    ...
    async function initializeOnboarding() {
      try {
        ...
        // Onboarding is non-essential — log and continue silently
        console.warn("Onboarding initialization skipped (endpoint unavailable):", error);

        hasInitialized.current = true; // Prevent retry loops
      }
    }

...
interface CreateTransportArgs {
  ...
  /** Ref to the current vertical domain context (system prompt override). */
  domainContextRef: MutableValue<string | null>;
}
    ...
    prepareSendMessagesRequest: async ({ messages }) => {
      ...
      return {
        body: {
          ...
          context: domainContextRef.current
            ? { content: domainContextRef.current }
            : null,

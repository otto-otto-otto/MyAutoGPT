...
class ClaudeCodeBlock(Block):
    ...
    async def run(
        ...
        **kwargs,
        ...
        # Claude Code block is permanently disabled — this project uses
        # Chinese LLMs (DeepSeek/Qianfan/DashScope) exclusively.
        raise RuntimeError(
            "ClaudeCodeBlock is disabled. This project uses Chinese LLMs "
            "(DeepSeek, Qianfan, DashScope) exclusively. Claude Code CLI "
            "is not available."
        )
        try:
            (

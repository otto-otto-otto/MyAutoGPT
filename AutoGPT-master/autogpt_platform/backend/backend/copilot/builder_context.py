...
async def build_builder_system_prompt_suffix(session: ChatSession) -> str:
    """[AGENT-REMOVED] Always returns "" — builder/agent building knowledge has been disabled."""
    return ""
...
async def build_builder_context_turn_prefix(
    ...
    """[AGENT-REMOVED] Always returns "" — per-turn builder context has been disabled."""
    return ""

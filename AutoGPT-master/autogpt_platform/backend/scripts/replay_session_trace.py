...
def _block_from_dict(b: dict[str, Any]) -> ContentBlock | None:
    t = b.get("type")
    if t == "text":
...
def _fetch_observations(session_id: str) -> list[dict[str, Any]]:
...
def replay_session(session_id: str, result_subtype: str = "success") -> dict[str, Any]:
    ...
    unresolved: dict[str, list[tuple[str, dict[str, Any]]]] = {}
